    ...
    public static void main(String[] args) throws KeeperException, InterruptedException {
        ...
        */
        ...
        try (ZContext context = new ZContext()){
            ...
            zoo.create("/nodes/nodeD", ports, ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.EPHEMERAL);
                ...
                public void process(WatchedEvent e){
                    try {
                        if(zoo.exists(path, false) != null){
                            System.out.println("new node has been created from nodeD");
                        }else{
                            System.out.println("nodeD has been deleted");
                        }
