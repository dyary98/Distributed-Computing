    ...
    public static void main(String[] args) throws KeeperException, InterruptedException {
        ...
        */
        ...
        try (ZContext context = new ZContext()){
            ...
            zoo.create("/nodes/nodeC", ports, ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.EPHEMERAL);
            ...
            final String path= "/nodes/nodeC";
            byte[] bn = zoo.getData(path, new Watcher() {
                public void process(WatchedEvent e){
                    try {
                        if(zoo.exists(path, false) != null){
                            System.out.println("new node has been created from nodeC");
                        }else{
                            System.out.println("nodeC has been deleted");
                        }
